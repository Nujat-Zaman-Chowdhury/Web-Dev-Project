...
const AddAnimalModal = () => {
  ...
  <div class="input bg-[#F2F2F2] text-black flex items-center p-1  w-full max-w-xs rounded-md overflow-hidden mt-8 mx-auto">
      <div class="px-4 flex">
        <p class="text-black">Image</p>
      </div>
      <label for="uploadFile1" class="bg-[#CCC] text-black text-sm px-3 py-2.5 outline-none rounded-[8px] cursor-pointer ml-auto w-max block">upload</label>
